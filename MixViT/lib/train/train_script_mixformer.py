...
# network related
from lib.models.mixformer2_vit import build_mixformer2_vit, build_mixformer2_vit_online,build_mixformer2_deit
...
def run(settings):
    ...
    elif settings.script_name == "mixformerv2_deit":
        net = build_mixformer2_deit(cfg)
