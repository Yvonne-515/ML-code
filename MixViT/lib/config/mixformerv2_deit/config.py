...
cfg.MODEL.VIT_TYPE = 'deit3_4layers'
# MODEL.BACKBONE
...
cfg.TRAIN.CORNER_WEIGHT = 1.0
cfg.TRAIN.ATTN_WEIGHT = 1.0
cfg.TRAIN.FEAT_WEIGHT = 0.2
cfg.TRAIN.TEACHER_MODEL = False
cfg.TRAIN.FIND_UNUSED_PARAMETERS = False
cfg.TRAIN.REMOVE_LAYERS = []
cfg.TRAIN.INVALID_LAYERS = []
cfg.TRAIN.DISTILL_LAYERS_STUDENT = [1, 3, 5, 7]
cfg.TRAIN.DISTILL_LAYERS_TEACHER = [2, 5, 8, 11]
# TRAIN.SCHEDULER
...
cfg.DATA.TRAIN.DATASETS_NAME = ["SportsMOT"]#["LASOT", "GOT10K_vottrain"]
cfg.DATA.TRAIN.DATASETS_RATIO = [1]
cfg.DATA.TRAIN.SAMPLE_PER_EPOCH = 60000
# DATA.VAL
cfg.DATA.VAL = edict()
cfg.DATA.VAL.DATASETS_NAME = ["SportsMOT"]
