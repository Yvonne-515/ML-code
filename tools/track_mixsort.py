...
def make_parser():
    ...
    parser.add_argument("--alpha",type=float,default=0.7,help='fuse parameter')
    parser.add_argument("--radius",type=int,default=0,help='radius for computing similarity')
    
    parser.add_argument("--iou_only",dest="iou_only",default=True, action="store_true",help='only use iou for similarity')
    return parser
