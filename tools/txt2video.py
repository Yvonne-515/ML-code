...
def txt2img(visual_path="visual_br"):
    ...
    for show_video_name in show_video_names:
        ...
        elif visual_path == "visual_br":
            txt_path = 'TrackEval/data/trackers/mot_challenge/sports-val/BM_total/data/' + show_video_name + '.txt'
